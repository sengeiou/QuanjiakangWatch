...
public class ChangeBirthDialog extends Dialog implements android.view.View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initDays(day);
        mDaydapter = new CalendarTextAdapter(context, arry_days, currentDay - init_day, maxTextSize, minTextSize);
        wvDay.setVisibleItems(5);
        wvDay.setViewAdapter(mDaydapter);
        wvDay.setCurrentItem(currentDay - init_day);
    ...
    public void initYears() {
        for (int i = getYear(); i < getYear() + 20; i++) {
            arry_years.add(i + "");
        }
    }
